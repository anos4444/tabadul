...
app_description = "Nextcloud for Frappe: route document attachments to per-company Nextcloud instances, and issue expiring, revocable, password-protected shares to external recipients."
